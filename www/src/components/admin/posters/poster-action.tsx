...
import { TablePoster } from "./posters-table";

interface PageProps {
    user: TablePoster;
}

export function PosterAction({ user }: PageProps) {
    const { refetch } = useUsers("poster");
        ...
        <>
            ...
            >
                <AlertDialogContent>
                    <AlertDialogHeader>
                        <AlertDialogTitle>
                            Demote {user.fullName}
                        </AlertDialogTitle>

                        <AlertDialogDescription>
                            Are you sure you want to demote {user.fullName} to{" "}
                            {ROLES.SEEKER.toUpperCase()}?
                        </AlertDialogDescription>
                    </AlertDialogHeader>
